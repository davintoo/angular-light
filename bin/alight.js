/**
 * Angular Light 1.0.1-alpha
 * (c) 2016 Oleg Nechaev
 * Released under the MIT License.
 * 2017-09-17, http://angularlight.org/ 
 */(function() {
    "use strict";
...
scanCore = function(topCD, result) {
  var a0, a1, cd, changes, e, extraLoop, index, j, last, len, locals, mutated, queue, ref, root, total, value, w;
  root = topCD.root;
  extraLoop = false;
  changes = 0;
  total = 0;
...
ChangeDetector.prototype.setValue = function(name, value) {
  var cd, e, fn, j, key, len, locals, msg, ref, rx;
  cd = this;
...
bindElement = (function() {
  return function(cd, element, config) {
    var args, attr, attrName, attrValue, bindResult, childElement, childNodes, childOption, d, directive, e, env, fastBinding, fb, index, j, len, len1, len2, list, n, o, r, ref, ref1, skipChildren, skipToElement, skip_attr, value;
    fb = {
      attr: [],
      dir: [],
      children: []
...
alight.nextTick = (function() {
  ...
  list = [];
  exec = function() {
    var callback, dlist, e, it, j, len, self;
    timer = null;
    dlist = list.slice();
    list.length = 0;
